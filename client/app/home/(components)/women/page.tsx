...
const Women=()=>{
    ...
    useEffect(() => {
        const fetchData = async () => {
          try {
            const res = await fetch("http://localhost:8000/products/category/"+2);
        ...
        <div>
            <Contenair>
                <div className="mt-10 flex items-center justify-center">
                    <img src="https://cdn.venngage.com/template/thumbnail/full/4a4561e3-bada-4f2b-898f-60f8fdb0c8c3.webp"/>
                </div>
                <div className="flex  justify-center items-center mt-10 mb-10">
                <h1 className={`${redressed.className} font-extrabold text-4xl border-2`}>Women's Products</h1>
                </div>
