        ...
        <div>
            ...
            <Contenair>
                <div className="mt-10 flex items-center justify-center">
                        <img src=" https://luckypandakids.com/cdn/shop/files/Untitled_1200_x_400_px_2400_x_800_px_1.jpg?v=1685123308&width=1600"/>
                </div>
                <div className="flex  justify-center items-center mt-10 mb-10">
                <h1 className={`${redressed.className} font-extrabold text-4xl border-2`}>Babies's Products</h1>
                </div>
